...
class Context : public QObject
{
    ...
    public slots:
        ...
        void notifyCustomProgressStart(bool iDisplayDialog) { emit customProgressStart(); if (iDisplayDialog) emit progressDialogShow(); }
        void notifyCustomProgressEnd() { emit customProgressEnd(); }
        void notifyCustomProgressUpdate(int iValue) { emit customProgressUpdate(iValue); }
        void notifyProgressDialogMessage(QString iText) { emit progressDialogMessage(iText); }
    ...
    signals:
        ...
        // Custom Progress bar.
        void customProgressStart();
        void customProgressEnd();
        void customProgressUpdate(int);

        // Progress dialog.
        void progressDialogShow();
        void progressDialogHide();
        void progressDialogMessage(QString);
