...
Context::Context(MainWindow *mainWindow): mainWindow(mainWindow)
{
    ...
    // Connect general progress messages.
    connect(this, SIGNAL(progressDialogMessage(QString)), this->mainWindow, SLOT(setStatusDialogText(QString)), Qt::DirectConnection);
    connect(this, SIGNAL(customProgressUpdate(int)), this->mainWindow, SLOT(setStatusDialogValue(int)), Qt::DirectConnection);
    connect(this, SIGNAL(progressDialogShow()), this->mainWindow, SLOT(setStatusDialog()));
    connect(this, SIGNAL(customProgressEnd()), this->mainWindow, SLOT(clearStatusDialog()));

    // Connect general progress to Windows Task Bar button.
#if defined(_MSC_VER) && defined(_WIN64)
    connect(this, SIGNAL(customProgressUpdate(int)), this->mainWindow, SLOT(setTaskBarProgressValue(int)), Qt::DirectConnection);
    connect(this, SIGNAL(customProgressStart()), this->mainWindow, SLOT(setTaskBarProgressShow()));
    connect(this, SIGNAL(customProgressEnd()), this->mainWindow, SLOT(setTaskBarProgressHide()));
#endif
...
///////////////////////////////////////////////////////////////////////////////
/// \brief Context::isDevMode
///        This method indicates if GC has been started in development mode.
///
/// \return The development mode flag.
///////////////////////////////////////////////////////////////////////////////
bool Context::isDevMode()
{
    return MainWindow::gc_devMode;
}
