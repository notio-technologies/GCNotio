...
// Notio
// Package version
#define VERSION_NK "1.16.5"

// the next two will with each build/release
#define VERSION_LATEST 3991
#ifdef VERSION_NK
#define NK_VERSION_LATEST 1984
#endif
...
#else
// Default config for this release cycle
#define VERSION_CONFIG_PREFIX "https://cloud.notiokonect.com/api/v1/files/gc/3.5"
#define NK_MIN_VERSION 1979
#endif
