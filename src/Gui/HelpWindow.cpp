...
class TextPage : public QLabel
{
    public:
        ...
        QSize sizeHint() const { return QSize(400,375); }
};
...
HelpWindow::fillPage() {
    ...
    textPage->setText(tr("<center>"
                    ...
                    "<br><a href=\"https://notio.ai/gcnotio_quickstart\">Notio - Golden Cheetah Quick Start Guide</a>"
                    "<br><a href=\"https://notio.ai/getstarted\">Notio - Device Quick Start Guide</a>"
                    "<br><a href=\"https://desk.zoho.com/portal/notio/en/home\">Notio - Knowledge Base</a>"
