...
QString GcCrashDialog::versionHTML()
{
    ...
    // -- Notio device algorithms ----
    QString notioAlgoStr = "none";

#ifdef GC_HAVE_NOTIOALGO
#ifdef VERSION_NOTIOALGO
    notioAlgoStr = VERSION_NOTIOALGO;
#else
    notioAlgoStr = "yes";
#endif
#endif
    ...
    QString lib_version = tr(
            ...
            "<tr><td colspan=\"2\">NOTIOALGO</td><td>%20</td></tr>"    // Notio algorithms 20th argument
