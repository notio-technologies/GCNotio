...
AboutPage::AboutPage(Context *context) : context(context)
{
    ...
    text->setText(
              tr(
                ...
                "<p>For GC Notio fork, it can be obtained from<br>"
                "<a href=\"https://github.com/notio-technologies/GCNotio\">"
                "GC Notio GitHub repository</a>."
                ...
                "Virtual Speed courtesy of Tom Compton <a href=\"https://analyticcycling.blogspot.com/\">"
                "AnalyticCycling</a>.<br>"
                "<br>The core body temperature module was developed by the <br>"
                "<a href=\"https://www.usariem.army.mil/\">U.S. Army Research Institute of Environmental Medicine</a>"
