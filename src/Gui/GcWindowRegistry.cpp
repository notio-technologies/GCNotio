...
#define VIEW_INTERVAL 0x10
#define VIEW_DEV      0x80  // View for developers or Notio support.
...
GcWindowRegistry::initialize()
{
  static GcWindowRegistry GcWindowsInit[35] = {
    ...
    { VIEW_ANALYSIS|VIEW_INTERVAL, tr("3D Map"),GcWindowTypes::RideMap3DWindow },
    ...
    { VIEW_ANALYSIS|VIEW_DEV, tr("Notio VE Analysis"),GcWindowTypes::NotioVEWindow },
    { VIEW_ANALYSIS, tr("Notio CdA Analysis"),GcWindowTypes::NotioCDAWindow },
    //{ VIEW_ANALYSIS|VIEW_DEV, tr("Notch Player"),GcWindowTypes::NotchPlayer },    // Deprecated
    //{ VIEW_ANALYSIS|VIEW_DEV, tr("Notch 2D Plot"),GcWindowTypes::Notch2DGraph },  // Deprecated
...
GcWindowRegistry::newGcWindow(GcWinID id, Context *context)
{
    ...
    switch(id) {
#ifdef GC_HAVE_NOTIOALGO
    case GcWindowTypes::NotioVEWindow: returning = new NotioVEWindow(context); break;
    case GcWindowTypes::NotioCDAWindow: returning = new NotioCDAWindow(context); break;
#else
    case GcWindowTypes::NotioVEWindow: returning = new GcChartWindow(context); break;
    case GcWindowTypes::NotioCDAWindow: returning = new GcChartWindow(context); break;
#endif
    ...
    case GcWindowTypes::RideMap3DWindow: returning = new RideMap3DWindow(context); break;
