...
///////////////////////////////////////////////////////////////////////////////////
/// \brief IntervalTreeView::leaveEvent
///        This method is called upon a leave event of the mouse from the interval
///        tree view in the sidebar. It notifies all that the mouse is done
///        hovering the interval items.
///
/// \param[in] event    Event occured.
///////////////////////////////////////////////////////////////////////////////////
void IntervalTreeView::leaveEvent(QEvent *event)
{
    // Turn off hover when mouse leaves
    context->notifyIntervalHover(nullptr);
