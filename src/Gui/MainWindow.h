...
class MainWindow : public QMainWindow
{
    ...
    public:
        ...
        void saveRideEx(RideItem *ride, Context *context);
    ...
    protected:
        ...
        // Status dialog to show messages to the user.
        ProgressMessageDialog *m_statusDialog = nullptr;

#if defined(_MSC_VER) && defined(_WIN64)
        // Windows task bar button.
        QWinTaskbarButton *m_winTaskBar = nullptr;
#endif
    ...
    public slots:
        ...
        void messageInfoBox(QString, QString);

        // Progress Message dialog.
        void setStatusDialogText(QString iText);
        void setStatusDialogInformativeText(QString iText);
        void setStatusDialogTitle(QString iTitle);
        void setStatusDialogValue(int iValue);
        void setStatusDialog();
        void clearStatusDialog();

#if defined(_MSC_VER) && defined(_WIN64)
        // Windows task bar button progress.
        void setTaskBarProgressValue(int iValue);
        void setTaskBarProgressShow();
        void setTaskBarProgressHide();
#endif
        ...
        void setNotioMenuEnabled();
        void NotioMenuCompute();
        void NotioMenuSetCorrectAlt();
        void NotioMenuSetZeroAlt();
        void NotioMenuSetNewWheelSize();
        void NotioMenuSpeedSensorDelay();
#endif
...
signals:
    ...
    private:
        ...
        // Notio Upload menu.
        QMenu *m_notioUploadMenu = nullptr;

        // Notio Tool Menu.
#ifdef GC_HAVE_NOTIOALGO
        QMenu *notioToolsMenu = nullptr;
        QAction *m_constantAlt = nullptr;
        QAction *m_correctedAlt = nullptr;  
#endif
