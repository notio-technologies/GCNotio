...
class Tab: public QWidget
{
    ...
    public:
        ...
        int viewsCount() { return views->count(); }
...
///////////////////////////////////////////////////////////////////////////////
/// \brief The CustomProgressLine class
///        This class defines a 1px high progress line visible when a process
///        use it to show its progress.
///////////////////////////////////////////////////////////////////////////////
class CustomProgressLine : public QWidget
{
    Q_OBJECT

    public:
        CustomProgressLine(QWidget *parent, Context *context);
        ~CustomProgressLine() {}

    public slots:
        void paintEvent (QPaintEvent *event);
        void refresh(int iValue);
        void start();
        void stop();
