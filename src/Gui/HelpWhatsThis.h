...
Q_OBJECT
 ...
 public:
    enum GCHelp{ Default,
                 ...
                 MenuBar_Edit_FixBCVxUsingGarmin,   // Notio device data
                 MenuBar_Edit_FixNotioPowerDrops,   // Notio device data
                 MenuBar_Edit_FixNotioSpeedDrops,   // Notio device data
                 MenuBar_Edit_NotioComputeData,     // Notio device data
                 ...
                 ChartRides_Map,
                 ChartRides_Map3D,
                 ChartRides_Map3D_Config_Basic,
                 ChartRides_Map3D_Config_UserData,
                 ChartRides_2D,
                 ChartRides_3D,
                 ChartRides_Aerolab,
                 ...
                 FindIntervals_Err_AeroTest_SampleRate,
                 FindIntervals_Err_AeroTest_Min,
                 FindIntervals_Err_AeroTest_Distance,
                 FindIntervals_Err_AeroTest_Wind,
                 FindIntervals_Err_AeroTest_Altitude,
                 FindIntervals_Err_AeroTest_Sensors,
                 FindIntervals_Err_AeroTest_Out_Back,
                 FindIntervals_Err_AeroTest_Data,
                 FindIntervals_Err_Velodrome_NoLaps,
                 FindIntervals_Err_Velodrome_Acceleration,
                 FindIntervals_Err_Velodrome_Distance,
                 FindIntervals_Err_Velodrome_Speed,
                 FindIntervals_Err_Velodrome_Data,
         #endif
                 ...
                 Preferences_Athlete_ChartManager,
