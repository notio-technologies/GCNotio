...
class BestsMetricsPage : public QWidget
{
    ...
    const QString STR_AVAILABLE_METRICS = tr("GC Metrics");
    const QString STR_XDATA_METRICS = tr("XData Metrics");
    const QString STR_NOTIO_METRICS = tr("Notio Metrics");
    ...
    public slots:
        ...
        void notioMetricsChanged();
        void updateCurrentTabSelection(int);
        qint32 saveClicked();

    protected:

        bool changed;
        QTabWidget *tabMetricsType;
        QListWidget *availList;
        QListWidget *xdataList;
        QListWidget *m_notioMetricsList = nullptr;
...
///////////////////////////////////////////////////////////////////////////////////
/// \brief The chartTreeWidget class
///        This class is a tree widget for managing the charts list shown in the
///        chart manager.
///////////////////////////////////////////////////////////////////////////////////
class ChartTreeWidget : public QTreeWidget
{
    Q_OBJECT
    G_OBJECT

    public:
        ChartTreeWidget(QWidget *iParent = nullptr);
...
private:
    QModelIndexList m_selectedDragItems;

protected:
    void startDrag(Qt::DropActions iSupportedActions) override;
    void dropEvent(QDropEvent *iEvent) override;
    void keyPressEvent(QKeyEvent *iEvent) override;
};

///////////////////////////////////////////////////////////////////////////////////
/// \brief The ChartMngrPage class
///        This class is a dialog window in which the order of the charts for a
///        view can be managed.
///////////////////////////////////////////////////////////////////////////////////
class ChartMngrPage : public QWidget
{
    Q_OBJECT
    G_OBJECT

    public:
        ChartMngrPage(Context *);
        qint32 saveClicked();
    ...
    private:
        inline int tabIndex(const int);
        inline int viewIndex(const int);
        ChartTreeWidget *getChartsTree(const int);

        Context *m_context = nullptr;

        QTabWidget *m_viewTabs = nullptr;
        ChartTreeWidget *m_fields = nullptr;
        QMap<int, bool> m_tabsOrderChanged;
