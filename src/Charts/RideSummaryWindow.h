...
#ifdef GC_HAVE_NOTIOALGO
        // Notio Compute button.
        htmlButtonBridge *m_computeButton = nullptr;
        QWebChannel *m_htmlSummaryChannel = nullptr;
#endif
};

///////////////////////////////////////////////////////////////////////////////
/// \brief The htmlButtonBridge class
///        This class defines an object to be exposed to the javascript from
///        the ride summary html page.
///////////////////////////////////////////////////////////////////////////////
class htmlButtonBridge : public QObject
{
    Q_OBJECT
