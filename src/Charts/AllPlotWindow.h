...
class AllPlotWindow : public GcChartWindow
{
    ...
    public:
        ...
        void setEndSelection(AllPlot* plot, double xValue, bool newInterval);
        void clearSelection();
        void hideSelection();
   ...
   public slots:
    ...
    private:
        QMap<RideItem*, QMap<unsigned int, bool> > mapRideIntervalNewName;
        bool createNewInterval;
        bool toCheckIntegrity;
        IntervalItem *currentInterval;


    protected:
        unsigned int getNextSelectionId(RideItem *currentRide);
        unsigned int getLastSelectionId(RideItem *currentRide);
